...
#         self.model      = YOLO("YOLO_MODEL/troop.pt").to(self.device)
...
#         # 
#         # add a fxn to check for grid line to get present action state)
#         # 
#         actions = [
...
#     env = ClashRoyaleEnv()
#     # img = cv2.imread(r"C:\Users\shour\RL\CLASH_ROYALE\screenshots\card_1.png")
#     env._run_detection()
#     print(env._cached_results)
#     # print()
